    ...
    <header className="w-full bg-pageBackground border-b h-16">
      <div className="w-full px-2 sm:px-4 lg:px-6 flex items-center justify-between h-16">
        ...
        <nav className={`hidden md:flex space-x-6 lg:space-x-8 xl:space-x-10 flex-1 justify-center transition-all duration-300 ${
          ...
          {["Home", "Arts", "Artists", "Events", "Contact Us"].map((item) => (
            <a
              key={item}
              href="#"
        ...
        <div className="flex items-center  flex-shrink-0 relative">
          ...
          {/* Sign in Button */}
          <button className="px-4 sm:px-5 lg:px-6 py-2 rounded-full bg-gradient-to-b from-primary to-secondary text-white font-medium font-body shadow-md hover:shadow-[0_2px_10px_0_#BF4D4D] transition whitespace-nowrap text-sm sm:text-base">
            Sign in
          </button>
        </div>
      </div>
