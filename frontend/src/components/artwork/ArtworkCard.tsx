  ...
  return (
    ...
    >
      ...
      {imageURL ? (
        ...
        <div className="w-full h-[205px] bg-gray-100 flex items-center justify-center text-gray-300 text-4xl">
          🎨
        </div>
      )}
      ...
      <div className="px-3 py-2.5">
        <div className="flex items-center justify-between gap-1">
          ...
          >
            ...
            <span
              className={`font-['Rubik'] font-normal text-[13px] transition-colors duration-200
        ...
        <div className="mt-2 flex items-center justify-between">
          ...
          <span className="text-[#272727] font-['Roboto'] text-[14px] font-medium">
            <span className="text-[10px] font-light mr-0.5">LKR</span>
            {price}
          </span>
        </div>
      </div>
